function printTable() {
    ...
    newWindow.document.write(`
        ...
        <body>
            ...
            <div class="header">
                <h3>ໃບເບີກຈ່າຍເງິນເດືອນ ຂອງພະນັກງານ ບໍລິສັດ ຂໍ້ມູນຂ່າວສານສິນເຊື່ອແຫ່ງ ສປປ ລາວ <br>
                 ປະຈຳເດືອນ ${new Date().toLocaleDateString('en-GB',{year: 'numeric',month: '2-digit'})}</h3>
            </div>
